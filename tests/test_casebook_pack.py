"""Regression checks for the tidal-tool-query-lab casebook."""
...
from casebook.harness import assert_expected, tidal_tool_query_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tidal_tool_query_lab_summary(), assert_expected())
